...
Binary field - learning binary(BF-LB)  
...
Данная игра позволит игроку решать случайно генерируемые головоломки различной степени сложности, а также соревноваться с другими игроками с помощью локальной сети.
